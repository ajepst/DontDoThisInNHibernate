...
// Assembly: NHibernate, Version=3.3.0.4000, Culture=neutral, PublicKeyToken=aa95f207798dfdb4
// Assembly location: C:\working\opensource\DontDoThisInNHibernate\packages\NHibernate.3.3.0.4000\lib\Net35\NHibernate.dll
...
namespace NHibernate
{
  ...
  /// 
  /// <item>
  /// transient: not associated with any <c>ISession</c>
  /// </item>
  /// 
  /// <item>
  /// persistent: associated with a <c>ISession</c>
  /// </item>
  /// 
  /// </list>
  /// 
  ...
  public interface ISession : IDisposable
  {
    ...
    /// 
    /// </summary>
    /// <param name="theType">A persistent class</param><param name="id">A valid identifier of an existing persistent instance of the class</param><param name="lockMode">The lock level</param>
    /// <returns>
    ...
    /// 
    /// </summary>
    /// <param name="entityName">The entity-name of a persistent class</param><param name="id">a valid identifier of an existing persistent instance of the class </param><param name="lockMode">the lock level </param>
    /// <returns>
    ...
    /// 
    /// </remarks>
    /// <param name="theType">A persistent class</param><param name="id">A valid identifier of an existing persistent instance of the class</param>
    /// <returns>
    /// The persistent instance or proxy
    /// </returns>
    ...
    /// 
    /// </summary>
    /// <typeparam name="T">A persistent class</typeparam><param name="id">A valid identifier of an existing persistent instance of the class</param><param name="lockMode">The lock level</param>
    /// <returns>
    /// the persistent instance
    /// </returns>
    ...
    /// 
    /// </remarks>
    /// <typeparam name="T">A persistent class</typeparam><param name="id">A valid identifier of an existing persistent instance of the class</param>
    /// <returns>
    /// The persistent instance or proxy
    /// </returns>
    T Load<T>(object id);
    ...
    /// 
    /// </summary>
    /// <param name="entityName">The entity-name of a persistent class</param><param name="id">a valid identifier of an existing persistent instance of the class </param>
    /// <returns>
    /// The persistent instance or proxy
    /// </returns>
    /// 
    ...
    /// 
    /// </summary>
    /// <param name="obj">An "empty" instance of the persistent class</param><param name="id">A valid identifier of an existing persistent instance of the class</param>
    ...
    /// 
    /// </summary>
    /// <param name="obj">A transient instance of a persistent class</param><param name="id">An unused valid identifier</param>
    ...
    /// 
    /// </summary>
    /// <param name="entityName">The Entity name.</param><param name="obj">a transient instance of a persistent class </param>
    /// <returns>
    /// the generated identifier
    /// </returns>
    /// 
